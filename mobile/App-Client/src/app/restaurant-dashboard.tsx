...
export default function RestaurantDashboard() {
  ...
  return <SafeAreaView style={styles.safe}>
    ...
    <Pressable onPress={() => router.push("/restaurant-menu")} style={styles.lienMenu}>
      <Text style={styles.lienMenuTexte}>Gérer mon menu</Text>
      <Text style={styles.lienMenuFleche}>→</Text>
    </Pressable>
...
const styles = StyleSheet.create({
  ...
  lienMenu: { marginHorizontal: 20, marginBottom: 14, backgroundColor: palette.blanc, borderWidth: 1, borderColor: palette.bordure, borderRadius: 16, paddingVertical: 15, paddingHorizontal: 18, flexDirection: "row", justifyContent: "space-between", alignItems: "center" },
  lienMenuTexte: { fontWeight: "900", fontSize: 16, color: palette.texte },
  lienMenuFleche: { fontSize: 20, color: palette.orangeFonce, fontWeight: "900" },
